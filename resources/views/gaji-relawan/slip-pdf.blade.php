...
<head>
    ...
    <style>
        * {
        ...
        /* Container halaman, di-set grid 3 kolom 2 baris */
        .page {
            width: 297mm;
            height: 210mm;
            /* Fixed height for A4 */
        ...
        .slip-header-right .title {
            font-weight: normal;
            /* Di gambar kelihatannya normal font */
        ...
        .slip-header-right td:first-child {
            width: 60%;
        }

        .slip-header-right td:nth-child(2) {
            width: 5%;
        }
        ...
        .slip-body-table td:first-child {
            width: 100px;
        }

        .slip-body-table td:nth-child(2) {
            width: 10px;
            text-align: center;
        }
        ...
        /* menyesuaikan first+second child padding di atas */
                    ...
                    <div class="slip-body">
                        <table class="slip-body-table">
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>{{ $danaKesehatan != 0 ? 'Rp' . number_format($danaKesehatan, 0, ',', '.') : '' }}
                                </td>
                            </tr>
