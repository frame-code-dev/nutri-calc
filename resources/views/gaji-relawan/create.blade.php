            ...
            <form method="POST" action="{{ route('gaji-relawan.store') }}" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div class="sm:col-span-2">
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Nama Periode <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Tipe Periode <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Periode Ke- <span class="text-red-500">*</span></label>
                        <select name="periode_ke" required class="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            @foreach(['I'=>1,'II'=>2,'III'=>3,'IV'=>4,'V'=>5,'VI'=>6,'VII'=>7,'VIII'=>8,'IX'=>9,'X'=>10,'XI'=>11,'XII'=>12] as $roman => $val)
                            <option value="{{ $val }}" {{ old('periode_ke') == $val ? 'selected' : '' }}>{{ $roman }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="instansi" value="{{ old('instansi', 'SATUAN PELAYANAN PEMENUHAN GIZI KEDOPOK JREBENG KULON 02') }}"
                               class="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        <p class="text-xs text-gray-400 mt-1">Muncul di header slip gaji</p>
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Mengetahui (Penandatangan 1)</label>
                        <input type="text" name="penandatangan_1" value="{{ old('penandatangan_1', 'Mentari Citra Aura Juliana, A.Md. Ak.') }}"
                               class="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Menyetujui (Penandatangan 2)</label>
                        <input type="text" name="penandatangan_2" value="{{ old('penandatangan_2', 'Ilyas Syams Sentosa, S.P.') }}"
                               class="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
