            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-8 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <p class="mt-2 text-xs text-gray-500">Each role has specific permissions. Choose
                                    carefully.</p>
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-900 mb-6 flex items-center">
                            <span
                                class="bg-blue-100 text-blue-600 w-8 h-8 rounded-lg flex items-center justify-center mr-3 text-sm">02</span>
                            Security
                        </h3>

                        <div
                            class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-blue-50/50 p-6 rounded-2xl border border-blue-100">
                            <!-- Password -->
                            <div class="col-span-1">
                                <label for="password"
