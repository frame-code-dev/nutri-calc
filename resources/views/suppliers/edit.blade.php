    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-8">
            <form action="{{ route('suppliers.update', $supplier) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="address" id="address" rows="3"
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('address') border-red-500 @enderror">{{ old('address', $supplier->address) }}</textarea>
                    @error('address')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mt-8 pt-8 border-t border-gray-200">
                ...
                <p class="text-sm text-gray-600 mb-4">Hapus supplier ini secara permanen. Tindakan ini tidak dapat dibatalkan!</p>
