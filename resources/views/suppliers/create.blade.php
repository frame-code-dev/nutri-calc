<x-app-layout>
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Tambah Supplier Baru</h2>
                <p class="text-sm text-gray-500 mt-1">Daftarkan mitra pemasok baru ke dalam sistem.</p>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="address" id="address" rows="3"
                                ...
                                placeholder="Jalan, Nomor, Kelurahan, Kota...">{{ old('address') }}</textarea>
                            @error('address')
                                <p class="mt-1 text-xs text-red-600 font-medium">{{ $message }}</p>
                            @enderror
                        </div>
