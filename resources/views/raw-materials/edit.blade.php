<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto" x-data="{ 
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            <form action="{{ route('raw-materials.update', $rawMaterial) }}" method="POST" class="space-y-8">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="2"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description', $rawMaterial->description) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div x-show="categoryId == foodCategoryId" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" class="bg-blue-50 p-6 rounded-xl border border-blue-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="energy_per_100g" id="energy_per_100g" value="{{ old('energy_per_100g', $rawMaterial->nutrition->energy_per_100g ?? '') }}" min="0" step="0.1" :required="categoryId == foodCategoryId"
                        ...
                        <div>
                            ...
                            <input type="number" name="protein_per_100g" id="protein_per_100g" value="{{ old('protein_per_100g', $rawMaterial->nutrition->protein_per_100g ?? '') }}" min="0" step="0.1" :required="categoryId == foodCategoryId"
                        ...
                        <div>
                            ...
                            <input type="number" name="fat_per_100g" id="fat_per_100g" value="{{ old('fat_per_100g', $rawMaterial->nutrition->fat_per_100g ?? '') }}" min="0" step="0.1" :required="categoryId == foodCategoryId"
                        ...
                        <div>
                            ...
                            <input type="number" name="carbohydrate_per_100g" id="carbohydrate_per_100g" value="{{ old('carbohydrate_per_100g', $rawMaterial->nutrition->carbohydrate_per_100g ?? '') }}" min="0" step="0.1" :required="categoryId == foodCategoryId"
                        ...
                        <div>
                            ...
                            <input type="number" name="fiber_per_100g" id="fiber_per_100g" value="{{ old('fiber_per_100g', $rawMaterial->nutrition->fiber_per_100g ?? '') }}" min="0" step="0.1" :required="categoryId == foodCategoryId"
            ...
            <div class="mt-8 pt-8 border-t border-gray-200">
                ...
                <p class="text-sm text-gray-600 mb-4">Hapus bahan baku ini secara permanen. Tindakan ini tidak dapat dibatalkan!</p>
                <form action="{{ route('raw-materials.destroy', $rawMaterial) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus bahan baku ini?')">
                    @csrf
                    @method('DELETE')
