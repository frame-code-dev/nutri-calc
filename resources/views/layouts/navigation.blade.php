            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @role('Koordinator Sekolah')
                         @php
                            $user = auth()->user();
                            $school = $user->schoolCoordinator?->school;
                        @endphp
                        @if($school)
                            <x-nav-link :href="route('calendars.index', ['school_id' => $school->id])" :active="request()->routeIs('calendars.*')">
                                📅 Kalender Sekolah
                            </x-nav-link>
                        @endif
                    @endrole
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('Super Admin|Admin MBG|Ahli Gizi')
                ...
                <x-responsive-nav-link :href="route('menu-schedules.index')" :active="request()->routeIs('menu-schedules.*')">
                    Siklus Menu
                </x-responsive-nav-link>
            @endrole
            ...
            @role('Koordinator Sekolah')
                ...
                @endphp
                @if($school)
                    <x-responsive-nav-link :href="route('calendars.index', ['school_id' => $school->id])" :active="request()->routeIs('calendars.*')">
                        Kalender Sekolah
                    </x-responsive-nav-link>
                @endif
            @endrole
