                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-amber-50/50 p-6 rounded-2xl border border-amber-100">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="daily_incentive" id="daily_incentive" value="{{ old('daily_incentive') }}" min="0" step="1000"
                                           class="block w-full px-4 py-3 border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-shadow"
                                           placeholder="20000">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="incentive_frequency" id="incentive_frequency" value="{{ old('incentive_frequency') }}"
                                           class="block w-full px-4 py-3 border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-shadow"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="work_days" id="work_days" value="{{ old('work_days') }}" min="0"
                                           class="block w-full px-4 py-3 border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-shadow"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 bg-green-50/50 p-6 rounded-2xl border border-green-100">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-center mt-2 text-gray-500">Siswa Tinggi + Bumil + Kader</p>
